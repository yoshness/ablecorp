<?php
/**
 * The template for displaying all Column posts
 */
			...
			<?php 
				if ( have_posts() ):
				    while ( have_posts() ):
				        ...
				        $post_category = get_the_terms( get_the_ID(), 'column_category' );
			?>
					<div class="l-article__content-main">
						<div class="l-article__content-top">
								<time datetime="<?php echo get_the_date( 'Y-m-d' ); ?>"><?php echo get_the_date('Y.m.d'); ?></time>
								<a href="<?php echo HOME_URL;?>column-category/<?php echo $post_category[0]->slug; ?>">
							...
							<div class="l-article__content-bottom">
								...
								<?php
									...
									foreach ( $categories as $cat) { ?>
										<a href="<?php echo HOME_URL;?>column-category/<?php echo $cat->slug; ?>">
											<?php echo $cat->name; ?>
										</a>
								<?php } ?>
							</div>
