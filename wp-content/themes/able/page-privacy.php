...
<main class="l-privacy" id="js-main-wrapper">
	<div class="l-privacy__top">
		<div class="l-container">
			...
			<h1 class="section-title">
				...
				<span class="section-title__ja">個人情報保護方針</span>
			</h1>
		</div>
	</div>
	<div class="l-privacy__content">
		<div class="l-container">
			<div class="l-privacy__content-main privacy">
				<h2><span class="u-show-pc">プライバシーポリシー・免責事項・著作権</span><span class="u-show-sp">プライバシーポリシー・免</span><span class="u-show-sp">責事項・著作権</span></h2>
				<p>以下では、株式会社LIG（以下当社といいます。）が管理、運営するすべてのサイト・サービス（以下「本サービス」といいます。）を利用するお客さま（以下「利用者」といいます。）と当社との間に適用される条件等を定めています。利用者が本サービスを利用する際には、以下の内容に同意の上、ご利用いただくようお願いします。なお、当社は、適宜、以下の内容を変更することができるものとします。</p>
				<h3>プライバシーポリシー</h3>
				<p>以下のとおり、当社の提供する本サービス全般における、利用者の個人情報の取扱いについて、プライバシーポリシーを定めます。</p>
				<h4>第1条（規約の適用）</h4>
				<ol>
					<li>本サービスの利用にあたっての登録手続は、当社所定の登録フォームにより、利用者本人が行うものとします。利用者は登録の際、提示する項目に関して正確な情報を登録するものとします。</li>
					<li>利用者が登録フォームにおいて必要項目を入力し、登録をした時点で、利用者は本規約の内容に同意したものとします。</li>
				</ol>
				<h4>第2条（登録個人情報）</h4>
				<ol>
					<li>当社は、利用者が登録した個人情報を、個人情報の保護に関する法律その他関係する法律に従い適切に取り扱うとともに、厳重に管理します。</li>
					<li>当社は、個人情報の取扱いに関する苦情及び相談対応への内部規程を定め、苦情及び相談には、迅速かつ誠実に対応いたします。</li>
					<li>当社は、利用者が登録した個人情報を次の利用目的の範囲内で利用します。
						<ol>
					...
					<li>当社は、法律上の根拠に基づき要求された場合および利用者の同意を得た場合を除き、利用者個人を特定できる個人情報を第三者に開示しないものとします。</li>
				</ol>
				<h4>第3条（メールマガジンの配信・配信停止）</h4>
				<ol>
					<li>利用者による本サービスの利用登録後、当社は利用者に対して、メールマガジン（メールマガジン関連の情報、告知、運営上の事務連絡に関連する電子メールを含む）を配信できるものとします。メールマガジンには当社の活動等に関する情報のほか、当社又はパートナー等第三者に関する広告、宣伝等が含まれる場合があります。</li>
				...
				<h4>第4条（個人情報の開示）</h4>
				<ol>
					<li>当社は、利用者から、個人情報保護法の定めに基づき個人情報の開示を求められたときは、利用者本人からの請求であることを確認の上で、利用者に対し、遅滞なく開示を行います（当該個人情報が存在しないときにはその旨を通知します。）。但し、個人情報保護法その他の法令により、当社が開示の義務を負わない場合は、この限りではありません。</li>
				</ol>
				<h4>第5条（個人情報の訂正及び利用停止）</h4>
				<ol>
					<li>当社は、利用者から、①個人情報が真実でないという理由によって個人情報保護法の定めに基づきその内容の訂正を求められた場合、及び、②あらかじめ公表された利用目的の範囲を超えて取り扱われているという理由、または偽りその他不正の手段により収集されたものであるという理由により、個人情報保護法の定めに基づき、その利用の停止を求められた場合には、利用者本人からの請求であることを確認の上で遅滞なく必要な調査を行い、その結果に基づき、個人情報の内容の訂正または利用停止を行い、その旨を利用者に通知します。なお、合理的な理由に基づいて訂正または利用停止を行わない旨の決定をしたときは、利用者に対しその旨を通知します。</li>
				</ol>
				<h4>第6条（利用者登録解除）</h4>
				<ol>
					<li>当社は、以下に該当する場合、利用者の本サービスへの利用登録を事前に通知することなく解除することがあります。
						<ol>
				...
				<ol>
					...
					<li>本サービスに第三者企業のサービスとの連携やタグの設置などを行うことにより、第三者企業がCookie情報を取得し利用する場合があります。その場合に取得されるCookie情報は、当社のサーバーではなく、第三者企業のサーバーに蓄積され、各第三者企業のプライバシーポリシーに従って管理されます。</li>
				</ol>
				<h4>第9条（ウェブサーバーの記録）</h4>
				<ol>
					<li>.当社のウェブサーバーは、利用者のコンピューターのIPアドレスを自動的に収集・記録しますが、これらは貴方個人を特定するものではありません。利用者自ら個人情報を開示しない限り、利用者は匿名のまま当社ウェブサイトを閲覧することが可能です。</li>
				</ol>
				<h4>第10条（準拠法および管轄裁判所）</h4>
				<ol>
					<li>第10条（準拠法および管轄裁判所）</li>
					<li>本規約に関する紛争の第一審の専属的合意管轄裁判所は、東京地方裁判所または東京簡易裁判所とします。</li>
				</ol>
				<h4>第11条（プライバシーポリシーの変更手続）</h4>
				<ol>
					<li>当社は、個人情報の取扱いに関する運用状況を適宜見直し、継続的な改善に努めるものとし、必要に応じて、本プライバシーポリシーを変更することがあります。変更した場合には、当社所定の方法で利用者に通知、公表します。</li>
				</ol>
				<blockquote>
					<strong>個人情報に関するお問い合わせ窓口</strong>
					<p>窓口	株式会社LIG</p>
					<p>所在地	東京都台東区東上野2-18-7 共同ビル10F</p>
					<p>電話	<strong>03-6240-1253</strong>（代表）</p>
				</blockquote>
				<h3>免責事項</h3>
				<p class="no-margin">当社は、以下の事項につき、一切の責任を負わないものとします。</p>
				<ol>
				...
				<p class="version">附則<br>2016年9月20日　制定・施行</p>
			</div>
		</div>
		<div class="l-privacy__decor">
