	...
	<div class="l-privacy__content">
		<div class="l-container">
			<div class="l-privacy__content-main privacy">
				...
				<p>以下では、able Co., Ltd.（以下当社といいます。）が管理、運営するすべてのサイト・サービス（以下「本サービス」といいます。）を利用するお客さま（以下「利用者」といいます。）と当社との間に適用される条件等を定めています。利用者が本サービスを利用する際には、以下の内容に同意の上、ご利用いただくようお願いします。なお、当社は、適宜、以下の内容を変更することができるものとします。</p>
				<h3>プライバシーポリシー</h3>
				...
				<blockquote>
					...
					<p>able Co., Ltd.</p>
					<p>東京都文京区本郷1-25-26 ベルファース本郷弓町706</p>
				</blockquote>
				<h3>免責事項</h3>
